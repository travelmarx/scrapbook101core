...
"categoryFields": {
    ...
    <br/>
    If loading test data and this field is set to "autogenerated", then a date value is set for the time at which the data is loaded. If loading test data and the field is already specified, e.g., as "yyyy-mm-dd", then the set date value is maintained.
    <p class="inset">
